  ...
  return (
    <div className="rounded-2xl border border-slate-200 bg-white shadow-sm">
      ...
      {reviews.length === 0 ? (
        ...
        <>
          <div className="mt-3 grid grid-cols-[1.5fr_1fr_1fr_2.4fr_1fr] border-b border-slate-100 px-6 py-2 text-[11px] font-semibold uppercase tracking-wider text-slate-400">
            <span>Customer</span>
            <span>Rating</span>
            <span>Status</span>
            <span>Reply</span>
          ...
          {rows.map((r) => (
            <div
              key={r._id}
              className="grid grid-cols-[1.5fr_1fr_1fr_2.4fr_1fr] items-center border-b border-slate-50 px-6 py-3.5 last:border-0 hover:bg-slate-50/60"
            >

  ...
  return (
    <div>
      ...
      <div className="rounded-2xl border border-slate-200 bg-white shadow-sm">
        <div className="grid grid-cols-[1.5fr_1fr_5fr_1fr_1fr] border-b border-slate-100 px-6 py-2.5 text-[11px] font-semibold uppercase tracking-wider text-slate-400">
          ...
          filtered.map((r) => {
            ...
            return (
              <div
                ...
                className="grid cursor-pointer grid-cols-[1.5fr_1fr_5fr_1fr_1fr] items-center border-b border-slate-50 px-6 py-3.5 last:border-0 transition hover:bg-slate-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-blue-400"
              >

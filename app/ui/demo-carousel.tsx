...
const SLIDES = [
  ...
  },
  {
    ...
    reply:
      "Hi Emma! Your kind words mean so much to us.\nWe are truly sorry the delivery let you down.\nWe're already fixing it. Please come back soon!",
  },
  {
  ...
  return (
    <div>
      <div className="flex items-center gap-4 mt-16 mb-5">
        <div className="h-px flex-1 max-w-[320px] bg-gradient-to-r from-transparent via-slate-300/40 to-slate-300/20" />
        <span className="text-xs uppercase text-slate-400 tracking-[0.22em]">See it in action</span>
      ...
      <div className="mt-5 mx-[5px] overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
        ...
        <div className="mt-[11.1px] flex items-center gap-2 pr-0 pl-[14px] py-1.5">
          ...
          <span className="ml-auto mr-[14px] translate-y-[1px] text-xs text-slate-500">{slide.businessType}</span>
        </div>
        ...
        >
          ...
          <div className="ml-[4px] mr-[12px] flex flex-1 flex-col justify-start h-[188px] min-w-0 overflow-hidden rounded-2xl border border-blue-100 bg-blue-50 pl-[3px] pr-[9px] pt-[20px] pb-2 text-left shadow-sm">
            <div className="mb-3 ml-[0.7px] flex items-center gap-[2px] text-blue-600">

    ...
    <div className="mt-10">
      ...
      <div className="mx-[5px] overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
        ...
        >
          ...
          <div className="ml-[48px] mr-[3px] flex flex-1 flex-col justify-start h-[194px] overflow-hidden rounded-2xl border border-slate-100/40 bg-slate-50 px-[9px] py-2 text-left">
          ...
          <div className="ml-[3px] mr-12 flex flex-1 flex-col justify-start h-[194px] min-w-0 overflow-hidden rounded-2xl border border-blue-100 bg-blue-50 pl-[11px] pr-[9px] pt-[20px] pb-2 text-left shadow-sm">

  ...
  return (
    <div className="mt-10">
      ...
      <div className="mx-[5px] overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
        ...
        {/* Two-panel grid */}
        <div
          className="flex flex-col gap-3 p-2 sm:flex-row sm:items-stretch min-h-[196px]"
          style={{
        ...
        >
          ...
          <div className="flex flex-1 flex-col justify-start overflow-hidden rounded-2xl border border-slate-100/40 bg-slate-50/40 px-[9px] py-3 text-left">
          ...
          <div className="flex flex-1 flex-col justify-start min-w-0 overflow-hidden rounded-2xl border border-blue-100 bg-blue-50 px-[9px] py-3 text-left shadow-sm">

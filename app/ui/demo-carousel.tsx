  ...
  return (
    <div className="mt-10">
      ...
      <div className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
        ...
        {/* Two-panel grid */}
        <div
          className="grid grid-cols-1 gap-3 p-2 sm:grid-cols-2 sm:gap-3"
          style={{
        ...
        >
          ...
          <div className="flex flex-col justify-start min-h-[192px] max-h-[272px] overflow-hidden rounded-2xl border border-slate-100/40 bg-slate-50/40 p-4 text-left">
          ...
          <div className="mt-1 flex flex-col justify-start min-h-[192px] max-h-[272px] min-w-0 overflow-hidden rounded-2xl border border-blue-100 bg-blue-50 p-4 text-left shadow-sm">

...
const HOW_IT_WORKS_STEPS: StepDef[] = [
  ...
  { n: 3, side: 'left',  icon: stepIcon('M7.5 8.25h9m-9 3H12m-9.75 1.51c0 1.6 1.123 2.994 2.707 3.227 1.129.166 2.27.293 3.423.379.35.026.67.21.865.501L12 21l2.755-4.133a1.14 1.14 0 01.865-.501 48.172 48.172 0 003.423-.379c1.584-.233 2.707-1.626 2.707-3.228V6.741c0-1.602-1.123-2.995-2.707-3.228A48.394 48.394 0 0012 3c-2.392 0-4.744.175-7.043.513C3.373 3.746 2.25 5.14 2.25 6.741v6.018z'), title: 'Generate your reply',      desc: 'AI adapts the tone. Reply in seconds.',             mock: <StepMock3 /> },
  { n: 4, side: 'right', icon: stepIcon('M16.862 4.487l1.687-1.688a1.875 1.875 0 112.652 2.652L10.582 16.07a4.5 4.5 0 01-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 011.13-1.897l8.932-8.931zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0115.75 21H5.25A2.25 2.25 0 013 18.75V8.25A2.25 2.25 0 015.25 6H10'), title: 'Review before sending',    desc: 'Edit or approve in just one click.',   mock: <StepMock4 /> },
  { n: 5, side: 'left',  icon: stepIcon('M6 12L3.269 3.126A59.768 59.768 0 0121.485 12 59.77 59.77 0 013.27 20.876L5.999 12zm0 0h7.5'),                                                title: 'Post to Google instantly', desc: 'Publish without copy-pasting or switching tabs.',        mock: StepMock5 },
]

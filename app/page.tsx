...
export default function Home() {
  return (
    <div className="relative min-h-screen overflow-hidden bg-[radial-gradient(ellipse_at_top_left,#d4e8ff,#edf5ff_35%,#f7fbff_65%,white)]">
      <div className="absolute -left-[180px] -top-[220px] z-0 h-[420px] w-[420px] pointer-events-none bg-[radial-gradient(circle,rgba(96,165,250,0.10),transparent_70%)]" />
      <div className="absolute inset-0 z-0 pointer-events-none bg-[radial-gradient(ellipse_at_95%_35%,rgba(186,230,253,0.19),transparent_52%)]" />
      <div className="absolute inset-x-0 top-0 z-0 h-[600px] pointer-events-none bg-[linear-gradient(180deg,rgba(203,224,255,0.10),transparent_50%)]" />
      <div className="absolute inset-0 z-0 pointer-events-none bg-[radial-gradient(circle_at_center,rgba(255,255,255,0.7),transparent_60%)]" />
